    ...
    return (
      <div className="min-h-screen py-8 flex items-center justify-center">
        <div className="flex items-center gap-3">
          ...
          <span className="text-muted-foreground">Memuat data qori...</span>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-500 rounded-2xl p-8 text-white">
            <div className="flex items-center gap-6">
              <div className="text-6xl">📖</div>
              <div>
                <h1 className="text-4xl font-bold mb-2">Ekstrakurikuler Qori</h1>
                <p className="text-indigo-100 text-lg">Seni Baca Al-Quran dan Tilawah</p>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Tentang Ekstrakurikuler Qori
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground mb-6">
                  Ekstrakurikuler Qori adalah tempat untuk mengembangkan kemampuan membaca Al-Quran dengan 
                  tartil dan indah. Kami fokus pada pembelajaran tajwid, makhorijul huruf, dan seni tilawah 
                  untuk mempersiapkan siswa dalam berbagai kompetisi MTQ dan festival Islami.
                </p>
                ...
                {achievements.length > 0 ? (
                  <div className="space-y-3">
                    {achievements.slice(0, 3).map((achievement) => (
                      <div
                        key={achievement.id}
                        className="p-3 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950 dark:to-purple-950 rounded-lg border"
                      >
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <p className="font-medium">Ustadz Muhammad Qori</p>
                  <p className="text-sm text-muted-foreground">Pembina Qori</p>
                  <p className="text-sm text-muted-foreground">📞 0817-8901-2345</p>
                  <p className="text-sm text-muted-foreground">✉️ muhammad.qori@smktibazma.sch.id</p>
                </div>
              </CardContent>
            </Card>
          </div>
